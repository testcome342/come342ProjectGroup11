...
public class MagazineAdvert extends TextAdvert{
	private String description;

	public MagazineAdvert(String adveretTitle, String targetCompletionDate, double estimatedAdvertCost,
	...
	public Advert createAdvert(int selectedClient,int selectedCampign) {
		...
		MagazineAdvert adverts=new MagazineAdvert(advertTitle,targetCompletionDate,estimatedAdvertCost,actualAdvertCost,
