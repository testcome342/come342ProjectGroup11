...
public class NewspaperAdvert extends TextAdvert {

	private String description;
	
	public NewspaperAdvert(String adveretTitle, String targetCompletionDate, double estimatedAdvertCost,
	...
	public Advert createAdvert(int selectedClient,int selectedCampign) {
		...
		NewspaperAdvert adverts=new NewspaperAdvert(advertTitle,targetCompletionDate,estimatedAdvertCost,actualAdvertCost,
